...
public class Animal {
	...
	public static Animal addNewAnimal(int ID, String name, Date dateOfBirth, double weight, String species,
			String breed, Date foundDate, ArrayList<String> specialNeedsList) {
		return new Animal(ID, name, dateOfBirth, weight, species, breed, foundDate, specialNeedsList);
	}

	public void editInformation(String name, Date dateOfBirth, Double weight, String species, String breed,
			Date foundDate, List<String> specialNeedsList, String status) {
		if (name != null) {
			this.name = name;
		}
		if (dateOfBirth != null) {
